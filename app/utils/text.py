...
_SYNONYM_REPLACEMENTS = {
    ...
    "pathailam": " sent ",
    "paisi": " received ",
    "pai nai": " not received ",
    "painai": " not received ",
    "paini": " not received ",
    "paye nai": " not received ",
    "kete geche": " deducted ",
    "kata gese": " deducted ",
    "kete gese": " deducted ",
    "taka kata": " money deducted ",
    "tk kata": " money deducted ",
    "tk": " taka ",
    "vul": " wrong ",
    "bhul": " wrong ",
    "vul number": " wrong number ",
    "bhul number": " wrong number ",
    "onno number": " wrong number ",
    "onnor number": " wrong number ",
    "ferot": " refund ",
    "ferot chai": " refund request ",
    "refund chai": " refund request ",
    "otp dise": " otp shared ",
    "pin dise": " pin shared ",
    "scammer taka niye niche": " scammer took money ",
    "taka niye niche": " money taken ",
    "bkash": "mobile_money",
    "bikash": "mobile_money",
    "বিকাশ": "mobile_money",
    "nagad": "mobile_money",
